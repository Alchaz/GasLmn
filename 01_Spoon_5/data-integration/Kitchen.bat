...
cd /D %CWD%
"%_PENTAHO_JAVA%" %OPT% -jar "%KETTLE_DIR%\launcher\pentaho-application-launcher-5.0.1-stable.jar" -main org.pentaho.di.kitchen.Kitchen %*
